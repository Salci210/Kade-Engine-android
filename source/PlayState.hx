	...
	private function popUpScore(daNote:Note):Void
		{
            ...
            {
                var notesplash:FlxSprite = new FlxSprite(daNote.x, strumLine.y);
...
notesplash.animation.addByPrefix("note3-0", "note impact 1 red", 24, false);
		...
		notesplash.animation.addByPrefix("note3-1", "note impact 2 red", 24, false)
                ...
                notesplash.animation.play('notesplash ' + 0 + " " + daNote.noteData);
                notesplash.antialiasing = FlxG.save.data.antialiasing;
                notesplash.offset.x += 70;
                notesplash.offset.y += 75;
